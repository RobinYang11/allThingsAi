...
def pca_recommend_movies(user_id, user_movie_matrix, num_recommendations=10):
    # 计算用户之间的余弦相似度
...
recommended_movies = pca_recommend_movies(user_id, user_movie_matrix)
print(f"Recommended movies for user {user_id} using PCA: {recommended_movies}")
